...
try:
	...
	print("No valid texlive installation found,"\
	      "ensure you have texlive and that 'kpsewhich' is in your PATH.", file=sys.stderr)
	exit(texmfHome.returncode)
...
setup(
	...
	description='Generates LaTeX documentation for Python3 code.',  # Required
	...
	url='https://github.comcast.com/Sensibility/dochelper',  # Optional
	...
	classifiers=[  # Optional
		...
		# Only generates documentation in English
	...
	keywords='latex tex xetex xelatex documentation python generate',  # Optional
	...
	entry_points={  # Optional
		'console_scripts': [
			'dochelper=dochelper.__init__:main',
		],
	},
